...
export const FOREST_AUTHORITY_SEED = idl.constants[0].value.replace('"', "");
export const FOREST_SEED = idl.constants[1].value.replace('"', "");
export const TREE_SEED = idl.constants[2].value.replace('"', "");
export const NODE_SEED = idl.constants[3].value.replace('"', "");
export const NOTE_SEED = idl.constants[4].value.replace('"', "");
export const STAKE_SEED = idl.constants[5].value.replace('"', "");
export const BRIBE_SEED = idl.constants[6].value.replace('"', "");
export const BRIBE_CLAIM_SEED = idl.constants[7].value.replace('"', "");
